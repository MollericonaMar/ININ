...
//buscador
public function searchByNameOrDescription($keyword)
{
    $sql = "SELECT * FROM productos WHERE nombre LIKE :keyword OR descripcion LIKE :keyword";
    $stmt = $this->db->prepare($sql);
    $keyword = "%" . $keyword . "%"; // Agregar los signos de porcentaje
