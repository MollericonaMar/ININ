...
class OrderController
{
  ...
  public function add()
  {
    ...
    $cellphone = $_POST["cellphone"] ?? false;
    $direction = $_POST["direction"] ?? false;
    $errors = 0;
    if (empty($cellphone) || !preg_match("/^[0-9]{6,8}$/", $cellphone)) {
      $_SESSION["errors"]["order-cellphone"] = "Número de celular ingresado no es válido.";
      $errors++;
  }
